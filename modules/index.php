<div class="d-none d-lg-block">
    <div id="slider" class="ls-wp-container fitvidsignore hero-7 th-hero-carousel"
        ...
        <div class="ls-slide"
            ...
            " class="ls-l ls-svg-layer" data-ls="static:forever;"><svg xmlns="http://www.w3.org/2000/svg"
                    viewbox="0 0 1920 900" fill="none">
    ...
    <div id="slider-phone" class="ls-wp-container fitvidsignore hero-7 th-hero-carousel"
        ...
        <div class="ls-slide"
            ...
            " class="ls-l ls-svg-layer" data-ls="static:forever;"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <rect width="500" height="600" fill="url(#paint0_radial_2726_7139)" fill-opacity="0.85"></rect>
                    <defs>
                        <radialgradient id="paint0_radial_2726_7139" cx="0" cy="0" r="1" gradientunits="userSpaceOnUse"
...
<section class="" data-pos-for="#testiSec">
        ...
        <div class="row justify-content-center justify-content-lg-between align-items-end">
            ...
            <div class="col-auto">
                <div class="sec-btn text-center">
                    <div class="icon-box">
                        <button data-slick-prev="#gallerySlide1" class="slick-arrow default">
                            <i class="far fa-arrow-left"></i>
                        </button>
                        <button data-slick-next="#gallerySlide1" class="slick-arrow default">
    ...
    <div class="px-sm-2 z-index-common">
        ...
        <div class="row align-items-center">
            <div class="col-xl-4 text-center text-xl-start">
                ...
                <div class="icon-box">
                    ...
                    <button data-slick-next="#testiSlide3" class="slick-arrow default">
                        <i class="far fa-arrow-right"></i>
                    </button>
                </div>
            </div>
            <div class="col-xl-8 mt-40 mt-xl-0">
                <div class="row th-carousel" id="testiSlide3" data-slide-show="2" data-lg-slide-show="2"
