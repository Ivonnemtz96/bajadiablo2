            ...
            <div class="col-lg-7">
                <div class="product-thumb-area">
                    ...
                    <div class="product-big-img th-carousel" data-slide-show="1" data-md-slide-show="1"
                        ...
                        <div class="col-auto">
                            <div class="img">
                                <img src="assets/img/menu/product_details_1_1.png" alt="Product Image" />
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="img">
                                <img src="assets/img/menu/product_details_1_2.png" alt="Product Image" />
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="img">
                                <img src="assets/img/menu/product_details_1_3.png" alt="Product Image" />
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="img">
                                <img src="assets/img/menu/product_details_1_4.png" alt="Product Image" />
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="img">
                                <img src="assets/img/menu/product_details_1_5.png" alt="Product Image" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 align-self-center">
                <div class="product-about">
                    ...
                    <p class="text">
                        ...
                        theresu anything embarrassing It’s a long established fact that
                        a reader will be looking at its layout.
                    </p>
                    <div class="actions">
                        <div class="quantity">
                    ...
                    <div class="product_meta">
                        ...
                        <span class="posted_in">Category:
                            <a href="shop.html" rel="tag">Chicken Pizza</a></span>
            ...
            <div class="widget_shopping_cart_content">
                <ul class="woocommerce-mini-cart cart_list product_list_widget">
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        ...
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                                    class="woocommerce-Price-currencySymbol">$</span>40.00</span></span>
                    </li>
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                    ...
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        ...
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                                    class="woocommerce-Price-currencySymbol">$</span>56.00</span></span>
                    </li>
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                        ...
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                                    class="woocommerce-Price-currencySymbol">$</span>23.00</span></span>
                    </li>
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                ...
                <p class="woocommerce-mini-cart__total total">
                    ...
                    <span class="woocommerce-Price-amount amount"><span
                            class="woocommerce-Price-currencySymbol">$</span>318.00</span>
                </p>
            ...
            <ul>
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="home-fast-food-rastaurant.html">Fast Food Restaurant</a>
                        </li>
                        <li><a href="home-fast-food.html">Fast Food Home</a></li>
                        <li>
                            <a href="home-tea-coffee.html">Tea Coffee Home <span class="new-label">New</span></a>
                        </li>
                        <li>
                            <a href="home-restaurant-v2.html">Restaurant Home <span class="new-label">New</span></a>
                        </li>
                        <li>
                            <a href="home-fast-food-v2.html">Fast Food Home <span class="new-label">New</span></a>
                        </li>
                        <li>
                            <a href="home-pizza-burger.html">Pizza & Burger Light <span class="new-label">New</span></a>
                        </li>
                        <li>
                            <a href="home-pizza-burger-dark.html">Pizza & Burger Dark <span
                        ...
                        <nav class="main-menu d-none d-lg-inline-block">
                            <ul>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="home-restaurant.html">Restaurant Home</a>
                                        </li>
                                        <li>
                                            <a href="home-fast-food-rastaurant.html">Fast Food Restaurant</a>
                                        </li>
                                        <li>
                                            <a href="home-fast-food.html">Fast Food Home</a>
                                        </li>
                                        <li>
                                            <a href="home-tea-coffee.html">Tea Coffee Home
                                                <span class="new-label">New</span></a>
                                        </li>
                                        <li>
                                            <a href="home-restaurant-v2.html">Restaurant Home
                                                <span class="new-label">New</span></a>
                                        </li>
                                        <li>
                                            <a href="home-fast-food-v2.html">Fast Food Home
                                                <span class="new-label">New</span></a>
                                        </li>
                                        <li>
                                            <a href="home-pizza-burger.html">Pizza & Burger Light
                                                <span class="new-label">New</span></a>
                                        </li>
                                        <li>
                                            <a href="home-pizza-burger-dark.html">Pizza & Burger Dark
                                                <span class="new-label">New</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="menu-fast.html">Fast Food Menu</a></li>
                                        <li>
                                            <a href="menu-fast-v2.html">Fast Food Menu v2</a>
                                        </li>
                                        <li>
                                            <a href="menu-rest.html">Restaurant Food Menu</a>
                                        </li>
                                        <li>
                                            <a href="menu-rest-v2.html">Restaurant Food Menu v2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="shop-details.html">Shop Details</a></li>
                                        <li>
                                            <a href="shop-details-v2.html">Shop Details v2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children mega-menu-wrap">
                                    ...
                                    <ul class="mega-menu">
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="reservation.html">Reservation</a></li>
                                                <li>
                                                    <a href="reservation-v2.html">Reservation v2</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="team-details-v2.html">Chef Details v2</a>
                                                </li>
                                                <li><a href="faq.html">Faq Page</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="testimonial.html">Testimonial</a></li>
                                                <li>
                                                    <a href="testimonial-v2.html">Testimonial v2</a>
                                                </li>
                                                <li><a href="contact.html">Contact Us</a></li>
                                                <li><a href="contact-v2.html">Contact Us v2</a></li>
                                                <li><a href="error.html">Error Page</a></li>
